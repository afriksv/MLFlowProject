        ...
        stage('Run experiment') 
                ...
                steps{
                    sh '''
                      ...
                      docker exec --ty docker-compose_mlflow_1 /bin/bash -c "mlflow models serve -m /home/aiops-user/artifact_root/0/edb6344e714d40389afc704f5f0ba2b8/artifacts/model -h 0.0.0.0 -p 5000"
                    '''
                    }
                }
      }
